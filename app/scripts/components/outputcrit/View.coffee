...
angular.module('assessory.task').controller 'outputcrit.AllocationsInfo', ($scope, CourseService, TaskService, TaskOutputService) ->
...
angular.module('assessory.task').directive "taskOutputCritiqueAllocations", () ->
  {
    scope: { task: '=task' }
